...
from ..schemas.long_term_memory import LongTermMemoryRequest, AddMemoryResponse, LongTermMemorySchema
...
router_memory = APIRouter (prefix="/memory", tags=["Memory"])
...
@router_memory.post(
    path="/search",
    response_model=List[LongTermMemorySchema]
)
